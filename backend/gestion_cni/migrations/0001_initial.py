# Generated by Django 4.2.20 on 2025-06-12 16:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pere_prenom', models.CharField(blank=True, default='', max_length=100, verbose_name='Prénom du père')),
                ('pere_nom', models.CharField(blank=True, default='', max_length=100, verbose_name='Nom du père')),
                ('mere_prenom', models.CharField(blank=True, default='', max_length=100, verbose_name='Prénom de la mère')),
                ...
                ('teint', models.CharField(blank=True, max_length=100, null=True, verbose_name='Teint')),
                ('signe_particulier', models.TextField(blank=True, null=True, verbose_name='Signe particulier')),
                ('photo', models.ImageField(blank=True, upload_to='photos/')),
                ('utilisateur', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='citoyen', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_fournie', models.ImageField(blank=True, null=True, upload_to='demandes_photos/', verbose_name='Photo fournie pour la demande')),
                ('signature_fournie', models.ImageField(blank=True, null=True, upload_to='demandes_signatures/', verbose_name='Signature fournie pour la demande')),
                ('numero_cni_precedent', models.CharField(blank=True, max_length=50, null=True, verbose_name='Numéro CNI précédente')),
                ...
                ('declaration_perte', models.FileField(blank=True, null=True, upload_to='declarations_perte/', verbose_name='Déclaration de perte')),
                ('agent_traitant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='demandes_traitees', to='gestion_cni.agent', verbose_name='Agent traitant')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('citoyen', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='extrait_naissance', to='gestion_cni.citoyen', verbose_name='Citoyen associé')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_telephone_paiement', models.CharField(blank=True, max_length=20, null=True, verbose_name='Numéro de téléphone du paiement')),
